...
Remove-Module shiftavenue.GraphAutomation -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\shiftavenue.GraphAutomation\shiftavenue.GraphAutomation.psd1"
Import-Module "$PSScriptRoot\..\shiftavenue.GraphAutomation\shiftavenue.GraphAutomation.psm1" -Force
