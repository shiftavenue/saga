...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\shiftavenue.GraphAutomation\functions", "$global:testroot\..\shiftavenue.GraphAutomation\internal\functions"),
	
	[string]
	$ModuleName = "shiftavenue.GraphAutomation",
...
$CommandPath = @(
    "$global:testroot\..\shiftavenue.GraphAutomation\functions"
    "$global:testroot\..\shiftavenue.GraphAutomation\internal\functions"
)
