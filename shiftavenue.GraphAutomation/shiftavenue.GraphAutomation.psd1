@{
    ...
    GUID                 = '30e6d1f0-f468-4732-b2ec-9b87427eac9c'
    ...
    Copyright            = '(c) shiftavenue GmbH. All rights reserved.'

    # Description of the functionality provided by this module
    Description          = 'Our collected Graph API automation knowledge.'
    ...
    FunctionsToExport    = @(
        ...
        'Get-SagaUserSigninMethodAndLicenseStatus'
